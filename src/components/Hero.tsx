        ...
        <div className="absolute top-32 right-1/3 animate-float" style={{ animationDelay: '3s' }}>
          <div className="relative group">
            <div className="w-8 h-8 md:w-12 md:h-12 bg-gradient-to-br from-blue-400/20 to-blue-500/20 rounded-full backdrop-blur-md border border-blue-300/20 flex items-center justify-center hover:scale-110 transition-all duration-500">
              <Atom className="w-4 h-4 md:w-6 md:h-6 text-blue-300 animate-spin" style={{ animationDuration: '6s' }} />
            </div>
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8">
        <div className="max-w-5xl">
          ...
          <div className="animate-fade-up">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600/20 to-blue-500/20 backdrop-blur-md rounded-full border border-blue-400/20 text-white text-sm font-medium mb-8 hover:scale-105 transition-all duration-300">
          ...
          <div className="animate-fade-up flex flex-col sm:flex-row gap-4 mb-16" style={{ animationDelay: '0.6s' }}>
            ...
            <Button 
              size="lg" 
              className="group relative bg-transparent border-2 border-blue-400/50 backdrop-blur-md text-white hover:bg-blue-500/20 hover:scale-105 transition-all duration-300 px-8 py-4 text-lg font-semibold rounded-xl h-auto"
            >
