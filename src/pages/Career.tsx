  ...
  return <>
      ...
      <section className="relative py-20 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img src="/assets/scientist-2.jpg" alt="Scientists collaborating in laboratory" className="w-full h-full object-cover" loading="eager" />
            ...
            <Card className="p-8 max-w-2xl mx-auto shadow-elegant">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="message" placeholder="Tell us about your experience and why you want to join our team..." rows={5} value={formData.message} onChange={e => setFormData({
                    ...formData,
